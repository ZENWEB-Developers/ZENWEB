...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceID = 'service_dtw1kld';
    const templateID = 'template_n810mnb';
    const userID = 'SKEqAVWebPTA7nmJA';

    try {
      const result = await emailjs.send(serviceID, templateID, formDetails, userID);
      setButtonText("Send");
